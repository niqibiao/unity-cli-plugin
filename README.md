...
**Codex CLI plugin for Unity Editor — powered by [unity-csharpconsole](https://github.com/niqibiao/unity-csharpconsole)**
...
Codex: Done. 10 cubes created at radius 5, each with a Rigidbody component.
```

### CLI + Skills, Not MCP

Same approach as [Playwright CLI](https://github.com/microsoft/playwright-cli) — CLI commands exposed through Codex CLI's skill system instead of MCP. Why:
...
**Prerequisites:** [Codex CLI](https://codex.com), Unity 2022.3+, Python 3.7+
...
Codex picks the right command or writes C# code as needed.
...
Run `$unity-cli-refresh-commands` to make Codex aware of new commands.
...
- **Plugin layer**: Skills and slash commands invoked by Codex CLI
