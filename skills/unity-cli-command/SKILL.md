...
```bash
python "${CODEX_PLUGIN_ROOT}/cli/cs.py" command --json --project "$(pwd)" <namespace> <action> ['<args-json>']
```
...
1. Check if `${CODEX_PLUGIN_ROOT}/skills/unity-cli-command/dynamic-commands.md` exists.
