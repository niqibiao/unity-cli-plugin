...
3. Compare with the static catalog in `${CODEX_PLUGIN_ROOT}/skills/unity-cli-command/SKILL.md`. The built-in namespaces are: editor, gameobject, component, transform, material, prefab, project, scene, screenshot, profiler, session, command.
